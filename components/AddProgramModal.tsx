    ...
    return (
        ...
        >
            <div
                ...
                className={`bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[80vh] flex flex-col border border-gray-200 transition-all duration-300 ease-out ${isAnimating ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
            >
                <div className="p-4 border-b border-gray-200 flex justify-between items-center flex-shrink-0">
                    <h3 className="text-lg font-semibold text-gray-900">Add Program to Comparison ({compareList.length}/4)</h3>
                ...
                <div className="p-4 flex-shrink-0">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="font-body w-full pl-10 pr-4 py-3 bg-gray-50 text-gray-900 rounded-md border border-gray-200 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 shadow-sm transition"
                            autoFocus
                        />
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-gray-200 flex-shrink-0">
                    <button onClick={handleClose} className="w-full px-4 py-2.5 bg-primary-600 text-white rounded-md hover:bg-primary-700 font-body font-medium transition-colors shadow-sm">Done</button>
                </div>
            </div>
        </div>
    );
