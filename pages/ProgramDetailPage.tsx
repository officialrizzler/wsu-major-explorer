        ...
        <div className="bg-gray-950">
            <div className="bg-gray-900 border-b border-gray-800 pt-12">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative pb-8">
                    <Link to="/explore" className="flex items-center gap-2 text-sm text-primary-400 mouse:hover:underline mb-8 font-semibold font-body">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <Widget title="Explore Job Opportunities" icon={<Building />}>
                            ...
                            <div className="mt-6 p-4 bg-primary-900/30 rounded-xl border border-primary-800 flex justify-between items-center">
                                ...
                                <a href="https://www.winona.edu/career/" target="_blank" rel="noopener noreferrer" className="font-body bg-primary-600 text-white font-semibold px-4 py-2 rounded-md mouse:hover:bg-primary-700">Visit <ExternalLink className="inline-block ml-1" size={14} /></a>
                            </div>
                        </Widget>
                            ...
                            <Widget title="Related Clubs & Orgs" icon={<Users size={20} />}>
                                <div className="flex flex-wrap gap-2">
                                    {program.clubs.map(club => (
                                        <a href={club.club_url} target="_blank" rel="noopener noreferrer" key={club.club_id} className="font-body bg-gray-700 text-sm font-medium px-3 py-1 rounded-full mouse:hover:bg-gray-600 transition">
                                            {club.club_name}
                                        </a>
                                    ))}
                                </div>
...
const CareerOutlookCard: React.FC<{ outcome: CareerOutcome }> = ({ outcome }) => {
    return (
        <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            ...
            <a href={outcome.occupation_data_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-primary-500 mouse:hover:underline font-body">
...
const JobLinkCard: React.FC<{ icon: React.ReactElement<{ size?: number }>, title: string, subtitle: string, href: string }> = ({ icon, title, subtitle, href }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="group p-4 bg-gray-800/50 rounded-xl border border-gray-700 flex items-center gap-4 mouse:hover:border-primary-500 mouse:hover:bg-gray-800 transition">
        ...
        <ExternalLink className="text-gray-400 mouse:group-hover:text-primary-600 transition" size={20} />
    </a>
);
